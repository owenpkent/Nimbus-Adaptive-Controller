...
**Problem statement:** [Input Ownership: Problem Statement](PROBLEM_STATEMENT.md) judges this track against every other boundary on one yardstick (sections 4 and 5). For the reference player it gives up the best GPU, which that document records as a decision.

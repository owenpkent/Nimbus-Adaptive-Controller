...
- [Target-Aware Aim Plan](vision/TARGET_AWARE_AIM_PLAN.md): a 2026-09-13 proposal, not adopted, for target-aware assistance in single-player games as the closed-loop step of Spectator+: the research on first-party lock-on, anti-cheat policy and the tooling, the rules that keep it defensible, a four-phase build measured against the harness, and the decision it needs first
